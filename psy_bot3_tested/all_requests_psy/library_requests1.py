...
def amo_share_incoming_message(chat_id: str, user_id: str, user_name: str, message_text: str, scope_id, secret):
...
def amo_share_outgoing_message(chat_id: str, user_id: str, user_name: str, message_text: str, scope_id, secret):
